...
def rawdata_to_featureForm():
    ...
    for i in range(len(listJudge)):
        ...
        feature_elememtsAndCrime.append({
            ...
            '被害身心狀況': 被害身心狀況,
            '和解狀況': 和解狀況,
            '告訴人和被告人之關係': 告訴人和被告人之關係,
            '法官心證': 法官心證,
            'T_278_score': T_278_score[0],  # 重傷害罪_分數
            'T_278_att_score': T_278_att_score[0],  # 重傷害未遂_分數
            'T_278_death_score': T_278_death_score[0],  # 重傷害致死_分數
            'T_284_score': T_284_score[0],  # 過失傷害_分數
            'T_284_serious_score': T_284_serious_score[0],  # 過失傷害致重傷_分數
            'T_277_score': T_277_score[0],  # 普通傷害_分數
            'T_277_serious_score': T_277_serious_score[0],  # 傷害致重傷害_分數
            'T_277_death_score': T_277_death_score[0],  # 傷害致死_分數
            'T_280_score': T_280_score[0],  # 傷直血_分數
            'T_280_death_score': T_280_death_score[0],  # 傷直血致死_分數
            'Recht_score': Recht_score[0],  # 無罪_分數
            'judge_crimePred': Crime_pred[1],  # 罪刑預測
            'crimePredCategory': Crime_pred[2],  # 罪刑預測分類別
            'judge_crime': listJudge[i]['judge_crime'],  # 罪名
            'crimeCategory': crimeCategory,  # 罪名分類別
...
def elements_to_judgecrime_2(strJudgeCont):
    T_278_score = [0, '重傷害罪', '1']            # 重傷害罪 1
    T_278_att_score = [0, '重傷害未遂', '2']      # 重傷害未遂 2
    T_278_death_score = [0, '重傷害致死', '3']     # 重傷害致死 3
    T_284_score = [0, '過失傷害', '4']             # 過失傷害 4
    T_284_serious_score = [0, '過失傷害致重傷', '5']  # 過失傷害致重傷 5
    T_277_score = [0, '普通傷害罪', '6']            # 普通傷害罪 6
    T_277_serious_score = [0, '傷害致重傷害', '7']  # 傷害致重傷害 7
    T_277_death_score = [0, '傷害致死', '8']      # 傷害致死 8
    T_280_score = [0, '傷直血', '9']              # 傷直血 9
    T_280_death_score = [0, '傷直血致死', '10']    # 傷直血致死 10
